          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className="font-semibold">Price after Sale</p>
                <p className="opacity-50 line-through">Real Price</p>
                <p className="text-green-600 font-semibold">Sale Percentage</p>
              </div>
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-50 text-sm"> Number of Ratings </p>
              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-6 gap-4 sm:grid-cols-8 lg:grid-cols-8">
